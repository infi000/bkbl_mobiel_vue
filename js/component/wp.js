...
Vue.component("component-wonderpage", {
    template: '<div class="page"  id="wonderBd">\
                    <div class="page__bd">\
                            <div id="wonderVideo" class="viewType"><img :src="info.image" alt="" style="width:100%" >\
                            ...
                            <article class="weui-article">\
                                    <section>\
                                        <section style=" border-bottom: 1px  groove #ddd;">\
                                            <h2 style="overflow:hidden">标题：{{info.title}}<a href="javascript:;" id="wonderBack">返回</a></h2>\
